document.addEventListener("DOMContentLoaded", function () {
    // Ensure this is linked properly to the button
    ...
    function savePlayerData() {
        ...
        const evaluationDate = document.getElementById('evaluationDate').value;  // Capture the selected date
    ...
    function loadPlayerData() {
        ...
        if (players[playerName]) {
            ...
            // Load the stored evaluation date
    ...
    function loadPlayerList() {
        ...
        Object.keys(players).forEach(playerName => {
            ...
            // Display the player's name with the date
